...
#ifndef __HMPCoreTestingUtilities_h
#define __HMPCoreTestingUtilities_h
...
/// defined in HMPCoreTestingMacros.h.

namespace HMPCoreTestingUtilities
{
...
#include "HMPCoreTestingUtilities.tpp"
