...
#ifndef __HMPScopedCurrentDir_h
#define __HMPScopedCurrentDir_h
...
class HMPScopedCurrentDirPrivate;
...
///
/// \ingroup Core
class HMP_CORE_EXPORT HMPScopedCurrentDir
{
public:
  explicit HMPScopedCurrentDir(const QString& path);
  virtual ~HMPScopedCurrentDir();
...
protected:
  QScopedPointer<HMPScopedCurrentDirPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(HMPScopedCurrentDir);
  Q_DISABLE_COPY(HMPScopedCurrentDir);
};
