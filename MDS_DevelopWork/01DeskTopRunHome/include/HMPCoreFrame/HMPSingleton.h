...
#ifndef __HMPSingleton_h
#define __HMPSingleton_h
...
#define HMP_SINGLETON_DECLARE(NAME)                \
...
/// 
#define HMP_SINGLETON_DECLARE_INITIALIZER(EXPORT_DIRECTIVE,NAME)   \
...
//
#define HMP_SINGLETON_DEFINE_INITIALIZER(NAME)      \
...
//
#define HMP_SINGLETON_DEFINE(NAME)                  \
...
{                                                   \
  delete Self::Instance;                            \
                                                    ...
                                                    \
HMP_SINGLETON_DEFINE_INITIALIZER(NAME)

///@}

#endif //__HMPSingleton_h
