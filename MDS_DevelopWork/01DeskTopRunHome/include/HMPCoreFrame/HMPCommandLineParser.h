...
#ifndef __HMPCommandLineParser_h
#define __HMPCommandLineParser_h
 ...
 */
class HMP_CORE_EXPORT HMPCommandLineParser : public QObject
{
  Q_OBJECT
...
public:
   ...
   */
  HMPCommandLineParser(QObject* newParent = 0);
   ...
   *
   */
  HMPCommandLineParser(QSettings* settings, QObject* newParent = 0);

  ~HMPCommandLineParser();
   ...
   * always start with "/".
   *
   * Note that all methods in HMPCommandLineParser which take an argument name
   * expect the name as it was supplied to <code>addArgument</code>.
   *
   * Example usage:
   *
   * \code
   * HMPCommandLineParser parser;
  ...
  /**
   * Enables QSettings support in HMPCommandLineParser. If an argument name is found
   ...
   * to disable merging.
   *
   * See <code>HMPCommandLineParser(QSettings*)</code> for information about how to
   ...
   *
   * @see HMPCommandLineParser(QSettings*)
   */
