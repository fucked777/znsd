...
#ifndef HMPPLUGINARCHIVESQL_P_H
#define HMPPLUGINARCHIVESQL_P_H
...
#include "HMPPluginArchive_p.h"
#include "HMPPluginManifest_p.h"

// HMP foraward declarations
class HMPPluginStorageSQL;
 ...
 *
 */
class HMPPluginArchiveSQL : public HMPPluginArchive
{
...
public:
   ...
   *
   */
  HMPPluginArchiveSQL(HMPPluginStorageSQL* pluginStorage, const QUrl& pluginLocation,
   ...
   *
   */
  HMPPluginArchiveSQL(QSharedPointer<HMPPluginArchiveSQL> old, int generation,
   ...
   * This will delete the current HMPPluginArchiveSQL instance.
   */
  void purge();
  ...
  /**
   * Create a HMPPluginManifest using the Qt resource under META-INF/MANIFEST.MF
   */
...
private:
  ...
  HMPPluginManifest manifest;
  HMPPluginStorageSQL* storage;

};



#endif // HMPPLUGINARCHIVESQL_P_H
