...
#ifndef HMPPLUGINFRAMEWORKDEBUG_P_H
#define HMPPLUGINFRAMEWORKDEBUG_P_H
 ...
 */
class HMPPluginFrameworkDebug
{

public:
  HMPPluginFrameworkDebug();
...
#endif // HMPPLUGINFRAMEWORKDEBUG_P_H
