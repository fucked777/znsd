...
#ifndef HMPPLUGINFRAMEWORKLAUNCHER_H
#define HMPPLUGINFRAMEWORKLAUNCHER_H
...
class HMPPluginFrameworkLauncherPrivate;
 ...
 *
 * Sets up and starts the HMP Plugin Framework.
 *
 * This is a convenience class to start an instance of the HMP Plugin
 * Framework and to install and start plugins.
 */
class HMP_PLUGINFW_EXPORT HMPPluginFrameworkLauncher
{
public:
  ...
  static const QString PROP_PLUGINS; // = "HMP.plugins";
  static const QString PROP_PLUGINS_START_OPTIONS; // = "HMP.plugins.startOptions";
  static const QString PROP_DEBUG; // = "HMP.debug";
  static const QString PROP_DEV; // = "HMP.dev";
  static const QString PROP_CONSOLE; // = "HMP.console";
  static const QString PROP_OS; // = "HMP.os";
  static const QString PROP_ARCH; // = "HMP.arch";

  static const QString PROP_NOSHUTDOWN; // = "HMP.noShutdown";
  static const QString PROP_IGNOREAPP; // = "HMP.ignoreApp";

  static const QString PROP_INSTALL_AREA; // = "HMP.install.area";
  static const QString PROP_CONFIG_AREA; // = "HMP.configuration.area";
  static const QString PROP_SHARED_CONFIG_AREA; // = "HMP.sharedConfiguration.area";
  static const QString PROP_INSTANCE_AREA; // = "HMP.instance.area";
  static const QString PROP_USER_AREA; // = "HMP.user.area";
  static const QString PROP_HOME_LOCATION_AREA; // = "HMP.home.location";


  static const QString PROP_CONFIG_AREA_DEFAULT; // = "HMP.configuration.area.default";
  static const QString PROP_INSTANCE_AREA_DEFAULT; // = "HMP.instance.area.default";
  static const QString PROP_USER_AREA_DEFAULT; // = "HMP.user.area.default";

  static const QString PROP_EXITCODE; // = "HMP.exitcode";
  static const QString PROP_EXITDATA; // = "HMP.exitdata";
  static const QString PROP_CONSOLE_LOG; // = "HMP.consoleLog";

  static const QString PROP_ALLOW_APPRELAUNCH; // = "HMP.allowAppRelaunch";
  static const QString PROP_APPLICATION_LAUNCHDEFAULT; // = "HMP.application.launchDefault";

  static const QString PROP_OSGI_RELAUNCH; // = "HMP.pluginfw.relaunch";
   ...
   */
  static void setFrameworkProperties(const HMPProperties& props);
   ...
   * @throws Exception if anything goes wrong
   */
  static HMPPluginContext* startup(QRunnable* endSplashHandler);
   ...
   * HMPPluginFramework object, if no plugin context is provided and
   ...
   */
  static long install(const QString& symbolicName, HMPPluginContext* context = 0);
   ...
   * to #addSearchPath(const QString&, bool) and in the default
   * HMP plugin installation path and is started using the given <code>options</code>.
   *
   * <p>
   ...
   *
   * \see HMPPlugin::StartOptions
   */
  static bool start(const QString& symbolicName = QString(),
                    HMPPlugin::StartOptions options = HMPPlugin::START_ACTIVATION_POLICY,
                    HMPPluginContext* context = 0);
   ...
   */
  static HMPPluginContext* getPluginContext();
   ...
   */
  static QSharedPointer<HMPPluginFramework> getPluginFramework();
   ...
   *
   * When calling #install(const QString&, HMPPluginContext*), #start, or
   ...
   * <code>searchPath</code>, which may not represent loadable HMP plugins.
   *
...
private:
  ...
  static const QScopedPointer<HMPPluginFrameworkLauncherPrivate> d;

  Q_DISABLE_COPY(HMPPluginFrameworkLauncher)
};

#endif // HMPPLUGINFRAMEWORKLAUNCHER_H
