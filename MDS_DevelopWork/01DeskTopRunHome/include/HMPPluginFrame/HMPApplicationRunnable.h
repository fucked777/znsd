...
#ifndef HMPAPPLICATIONRUNNABLE_H
#define HMPAPPLICATIONRUNNABLE_H
 ...
 * </p>
 */
struct HMP_PLUGINFW_EXPORT HMPApplicationRunnable
{

  virtual ~HMPApplicationRunnable();
...
#endif // HMPAPPLICATIONRUNNABLE_H
