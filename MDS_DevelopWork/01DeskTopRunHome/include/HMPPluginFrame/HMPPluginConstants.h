...
#ifndef HMPPLUGINCONSTANTS_H
#define HMPPLUGINCONSTANTS_H
 ...
 */
struct HMP_PLUGINFW_EXPORT HMPPluginConstants {

  /**
   * Location identifier of the HMP <i>system plugin</i>, which is defined
   * to be &quot;System Plugin&quot;.
   */
  static const QString SYSTEM_PLUGIN_LOCATION; // = "System Plugin"

  /**
   * Alias for the symbolic name of the HMP <i>system plugin</i>. It is
   ...
   * <code>HMPPluginContext::getProperty</code> method.
   */
   ...
   * <p>
   * The attribute value may be retrieved from the <code>QHash</code>
   * object returned by the <code>HMPPlugin::getHeaders</code> method.
   */
   ...
   * returned by the <code>HMPPlugin::getHeaders</code> method.
   */
   ...
   */
  static const QString PLUGIN_LOCALIZATION_DEFAULT_BASENAME; // = "HMP-INF/l10n/plugin"
   ...
   *
   * <p>
   * The attribute value may be retrieved from the <code>HMPDictionary</code>
   * object returned by the <code>HMPPlugin::getHeaders()</code> method.
   */
   ...
   * HMPPlugin#START_ACTIVATION_POLICY option will be activating immediately when
   ...
   * @see HMPPlugin#start(int)
   * @see HMPPlugin#START_ACTIVATION_POLICY
   */
   ...
   * {@link HMPPlugin#START_ACTIVATION_POLICY START_ACTIVATION_POLICY} option
   * will wait in the HMPPlugin#STARTING state until the first
   ...
   */
  // ATTENTION!!! If the value is changed, change also HMPEventConstants::SERVICE_ID
   ...
   * <code>HMPDictionary</code> object passed to the
   * <code>HMPPluginContext#registerService</code> method. The value of this
   ...
   * the plugin's identifier (see HMPPlugin::getPluginId) and followed by
   * a dot (.). A plugin may use this as the prefix of the persistent
   * identifiers for the services it registers.
   */
  // ATTENTION!!! If the value is changed, change also HMPEventConstants::SERVICE_PID
   ...
   * order</i> of services, see HMPServiceReference::operator<(const HMPServiceReference&),
   * and the <i>default</i> service to be returned from a call to the
   * {@link HMPPluginContext::getServiceReference} method.
   *
   * <p>
   ...
   *
   * <p>
   * This property may be supplied in the properties <code>HMPDictionary</code> object
   * passed to the <code>HMPPluginContext::registerService()</code> method.
   */
