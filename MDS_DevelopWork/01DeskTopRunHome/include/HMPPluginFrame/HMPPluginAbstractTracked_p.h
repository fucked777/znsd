...
#ifndef HMPPLUGINABSTRACTTRACKED_P_H
#define HMPPLUGINABSTRACTTRACKED_P_H
 ...
 * then a new HMPPluginAbstractTracked object is used. This class acts as a map of tracked
...
class HMPPluginAbstractTracked : public QMutex
{
...
public:
  ...
  /**
   * HMPPluginAbstractTracked constructor.
   */
  HMPPluginAbstractTracked();

  virtual ~HMPPluginAbstractTracked();
...
#include "HMPPluginAbstractTracked.tpp"

#endif // HMPPLUGINABSTRACTTRACKED_P_H
