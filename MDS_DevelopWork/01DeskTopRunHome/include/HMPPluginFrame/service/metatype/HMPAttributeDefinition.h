...
#ifndef HMPATTRIBUTEDEFINITION_H
#define HMPATTRIBUTEDEFINITION_H
 ...
 *
 * <p>
 * An <code>HMPAttributeDefinition</code> object defines a description of the data type
 * of a property/attribute.
 */
struct HMP_PLUGINFW_EXPORT HMPAttributeDefinition
{
  ...
  virtual ~HMPAttributeDefinition() {}
   ...
   *
   * The HMP Plugin environment handles multi valued attributes in QList
   ...
   *
   * <p>
   * QVariant::UserType maps to HMPAttributeDefinition::Password only.
   *
   * @return The type for this attribute.
   */
 ...
 * \ingroup Metatype
 */
typedef QSharedPointer<HMPAttributeDefinition> HMPAttributeDefinitionPtr;

Q_DECLARE_METATYPE(HMPAttributeDefinition::Password)


#endif // HMPATTRIBUTEDEFINITION_H
