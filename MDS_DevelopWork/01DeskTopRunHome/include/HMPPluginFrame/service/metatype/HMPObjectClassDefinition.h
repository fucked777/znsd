...
#ifndef HMPOBJECTCLASSDEFINITION_H
#define HMPOBJECTCLASSDEFINITION_H

#include "HMPAttributeDefinition.h"
 ...
 */
struct HMPObjectClassDefinition
{
  ...
  virtual ~HMPObjectClassDefinition() {}
  ...
  *
  * <p>
  * <code>HMPObjectClassDefintion</code> objects share a global namespace in the
  ...
  */
  virtual QList<HMPAttributeDefinitionPtr> getAttributeDefinitions(Filter filter) = 0;
 ...
 * \ingroup Metatype
 */
typedef QSharedPointer<HMPObjectClassDefinition> HMPObjectClassDefinitionPtr;

#endif // HMPOBJECTCLASSDEFINITION_H
