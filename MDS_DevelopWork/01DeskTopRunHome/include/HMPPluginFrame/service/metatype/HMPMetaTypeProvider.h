...
#ifndef HMPMETATYPEPROVIDER_H
#define HMPMETATYPEPROVIDER_H

#include "HMPObjectClassDefinition.h"
 ...
 */
struct HMP_PLUGINFW_EXPORT HMPMetaTypeProvider
{

  /**
   * Service property to signal that this service has
   * {@link HMPObjectClassDefinition} objects for the given PIDs. The type of
   ...
   * @return A <code>HMPObjectClassDefinition</code> object.
   */
  virtual HMPObjectClassDefinitionPtr getObjectClassDefinition(
...
Q_DECLARE_INTERFACE(HMPMetaTypeProvider, "org.commontk.service.metatype.MetaTypeProvider")

#endif // HMPMETATYPEPROVIDER_H
