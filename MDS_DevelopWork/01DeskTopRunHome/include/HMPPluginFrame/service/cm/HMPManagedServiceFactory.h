...
#ifndef HMPMANAGEDSERVICEFACTORY_H
#define HMPMANAGEDSERVICEFACTORY_H
 ...
 * <code>HMPConfiguration</code> object that has a PID. When such a
 * <code>HMPConfiguration</code> is updated, the Configuration Admin service
 * calls the <code>HMPManagedServiceFactory</code> updated method with the new
 ...
 * corresponding <code>HMPConfiguration</code> object (but it should <b>not</b>
 ...
 * \code
 *
 *   class SerialPortFactory : public QObject, public HMPManagedServiceFactory
 *   {
 *
 ...
 *     {
 *       HMPDictionary properties;
 *       properties.insert(HMPPluginConstants::SERVICE_PID,
 *         "com.acme.serialportfactory");
 *       registration = context->registerService<HMPManagedServiceFactory>(
 *         this, properties);
 *     }
 *
 *   public:
 *
 *     void updated(const QString& pid, const HMPDictionary& properties)
 *     {
 ...
 * \endcode
 */
struct HMPManagedServiceFactory
{
  virtual ~HMPManagedServiceFactory() {}
   ...
   * instance.
   *
   * If the PID of the <code>HMPConfiguration</code> object is new for the
   ...
   * {@link HMPConfigurationException} which describes the problem.
   *
   * <p>
   * The Configuration Admin service must call this method asynchronously.
   * This implies that implementors of the <code>HMPManagedServiceFactory</code>
   ...
   *        <code>HMPConfiguration#getPluginLocation</code> method.
   * @throws HMPConfigurationException when the configuration properties are
   *         invalid.
   */
  virtual void updated(const QString& pid, const HMPDictionary& properties) = 0;
...
Q_DECLARE_INTERFACE(HMPManagedServiceFactory, "org.commontk.service.cm.ManagedServiceFactory")

#endif // HMPMANAGEDSERVICEFACTORY_H
