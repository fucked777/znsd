...
#ifndef HMPCONFIGURATIONPLUGIN_H
#define HMPCONFIGURATIONPLUGIN_H
 ...
 *
 * <p>
 * A plugin registers a <code>HMPConfigurationPlugin</code> object in order to
 ...
 * every time before it calls the <code>HMPManagedService</code> or
 * <code>HMPManagedServiceFactory</code>
 ...
 * <code>HMPServicePermission[HMPConfigurationPlugin,REGISTER]</code>.
 ...
 *
 */
struct HMP_PLUGINFW_EXPORT HMPConfigurationPlugin
{
  virtual ~HMPConfigurationPlugin() {};
   ...
   */
  virtual void modifyConfiguration(const HMPServiceReference& reference,
                                   HMPDictionary& properties) = 0;
};

Q_DECLARE_INTERFACE(HMPConfigurationPlugin, "org.commontk.service.cm.ConfigurationPlugin")

#endif // HMPCONFIGURATIONPLUGIN_H
