...
#ifndef HMPEVENTCONSTANTS_H
#define HMPEVENTCONSTANTS_H
 ...
 * \ingroup EventAdmin
 *
 * Defines standard names for <code>HMPEventHandler</code> and Qt event slot properties.
 *
 * \see HMPEventHandler
 * \see HMPEventAdmin::subscribeSlot()
 */
struct HMP_PLUGINFW_EXPORT HMPEventConstants {

  /**
   * Registration property (named <code>event.topics</code>)
   * specifying the <code>HMPEvent</code> topics of interest to an Event Handler
   ...
   * specifying a filter to further select <code>HMPEvent</code> s of interest to
  ...
  /**
   * The HMPPlugin object of the plugin relevant to the event. The type of the
   * value for this event property is <code>QSharedPointer<HMPPlugin></code>.
   */
  static const QString PLUGIN; // = "plugin"

  /**
   * The version of the plugin relevant to the event. The type of the value
   * for this event property is {@link HMPVersion}.
   */
   ...
   * <code>long</code>.
   */
  static const QString SERVICE_ID; // = HMPPluginConstants::SERVICE_ID
   ...
   */
  static const QString SERVICE_PID; // = HMPPluginConstants::SERVICE_PID
