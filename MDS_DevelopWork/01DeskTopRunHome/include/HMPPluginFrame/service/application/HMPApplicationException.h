...
#ifndef HMPAPPLICATIONEXCEPTION_H
#define HMPAPPLICATIONEXCEPTION_H
 ...
 * management.
 *
 * <code>HMPApplicationException</code> object is created by the Application Admin
 * to denote an exception condition in the lifecycle of an application.
 * <code>HMPApplicationException</code>s should not be created by developers. <br/>
 * <code>HMPApplicationException</code>s are associated with an error code. This
 ...
 * </ul>
 */
class HMP_PLUGINFW_EXPORT HMPApplicationException : public HMPException
{
...
public:
   ...
   */
  HMPApplicationException(int errorCode);
   ...
   */
  HMPApplicationException(int errorCode, const HMPException& cause);
   ...
   */
  HMPApplicationException(int errorCode, const QString& message);
   ...
   * @param cause The cause of this exception.
   */
  HMPApplicationException(int errorCode, const QString& message, const HMPException& cause);

  ~HMPApplicationException() throw();

  const char* name() const throw();

  HMPApplicationException* clone() const;
...
#endif // HMPAPPLICATIONEXCEPTION_H
