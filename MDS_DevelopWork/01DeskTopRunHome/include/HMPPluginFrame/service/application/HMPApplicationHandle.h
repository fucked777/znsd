...
#ifndef HMPAPPLICATIONHANDLE_H
#define HMPAPPLICATIONHANDLE_H
...
struct HMPApplicationDescriptor;
 ...
 */
struct HMP_PLUGINFW_EXPORT HMPApplicationHandle
{
   ...
   */
  virtual HMPApplicationDescriptor* getApplicationDescriptor() const = 0;
   ...
   * application has not terminated then an <code>HMPApplicationException</code>
   * is thrown.</li>
   *
   ...
   * terminated then an <code>HMPApplicationException</code> is thrown.</li>
   * </ul>
   *
   ...
   * @throws HMPUnsupportedOperationException If the application model does not
   *         support exit values.
   * @throws HMPApplicationException If the application has not terminated. The
   *         error code will be
   *         HMPApplicationException::APPLICATION_EXITVALUE_NOT_AVAILABLE.
   */
   ...
   * <p>
   * At the end the <code>HMPApplicationHandle</code> must be unregistered.
   * This method should  free all the resources related to this
   * <code>HMPApplicationHandle</code>.
   * <p>
...
Q_DECLARE_INTERFACE(HMPApplicationHandle, "org.commontk.service.application.ApplicationHandle")

#endif // HMPAPPLICATIONHANDLE_H
