...
#ifndef HMPPLUGINEXCEPTION_H
#define HMPPLUGINEXCEPTION_H
 ...
 *
 * <p>
 * A <code>HMPPluginException</code> object is created by the Framework to denote
 * an exception condition in the lifecycle of a plugin.
 * <code>HMPPluginException</code>s should not be created by plugin developers.
 * An enum type is used to identify the exception type for future extendability.
 *
 * <p>
 * This exception conforms to the general purpose exception chaining mechanism.
 */
class HMP_PLUGINFW_EXPORT HMPPluginException : public HMPRuntimeException
{
public:
  ...
  /**
   * Creates a <code>HMPPluginException</code> with the specified message and type.
   *
   * @param msg The associated message.
   * @param type The type for this exception.
   */
  HMPPluginException(const QString& msg, const Type& type = UNSPECIFIED);

  /**
   * Creates a <code>HMPPluginException</code> with the specified message, type
   * and exception cause.
   *
   * @param msg The associated message.
   * @param type The type for this exception.
   ...
   */
  HMPPluginException(const QString& msg, const Type& type, const HMPException& cause);

  /**
   * Creates a <code>HMPPluginException</code> with the specified message and
   * exception cause.
   *
   * @param msg The associated message.
   * @param cause The cause of this exception.
   */
  HMPPluginException(const QString& msg, const HMPException& cause);

  HMPPluginException(const HMPPluginException& o);
  HMPPluginException& operator=(const HMPPluginException& o);

  ~HMPPluginException() throw();
   ...
   */
  HMPPluginException* clone() const;
