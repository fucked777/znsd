...
#ifndef HMPPLUGINFRAMEWORK_GLOBAL_H
#define HMPPLUGINFRAMEWORK_GLOBAL_H
 ...
 * @{
 */
typedef QHash<QString, QVariant> HMPProperties;
typedef HMPProperties HMPDictionary;
...
#endif // HMPPLUGINFRAMEWORK_GLOBAL_H
