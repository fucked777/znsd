...
namespace bson {
    ...
    /* wo = "well ordered" */
    inline int NOINLINE_DECL BSONElement::woCompare( const BSONElement &e,
    ...
    */
    ...
    // {a: {b:1}} -> {a.b:1}
    void BSOM_EXPORT nested2dotted(BSONObjBuilder& b, const BSONObj& obj, const string&
      base="");
    ...
    // {a.b:1} -> {a: {b:1}}
    void BSOM_EXPORT dotted2nested(BSONObjBuilder& b, const BSONObj& obj);
