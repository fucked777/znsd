...
namespace bson {
    ...
    int BSOM_EXPORT compareElementValues(const BSONElement& l, const BSONElement& r);
	...
	*/
    ...
    private:
        ...
        int fieldNameSize() const {
			//std::cout << " =====  " << fieldNameSize_ << std::endl;
            if ( fieldNameSize_ == -1 )
                fieldNameSize_ = (int)strlen( fieldName() ) + 1;
			//std::cout << "fieldNameSize" << fieldNameSize_ << std::string(fieldName()) << std::endl;
