...
void DetectorPage::initMember()
{
    ...
    connect(notEditableDelegate, &NotEditableDelegate::checkCurrRowSignal, this, &DetectorPage::checkCurrRowSlot);
    ...
    connect(headerView, &HeaderView::selectOrDeselectAll, this, &DetectorPage::selectAllItems);
