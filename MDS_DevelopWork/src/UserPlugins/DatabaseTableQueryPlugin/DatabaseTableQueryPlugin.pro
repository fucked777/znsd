...
CONFIG += c++14 
TARGET = DatabaseTableQueryPlugin 
...
HEADERS += \
    DatabaseTableQueryDialog.h \
    idatabasetablequerypluginservice.h  \ 
    databasetablequerypluginservice.h  \ 
    databasetablequerypluginactivator.h 

SOURCES += \
    DatabaseTableQueryDialog.cpp \
    databasetablequerypluginservice.cpp \ 
    databasetablequerypluginactivator.cpp 

RESOURCES += \
    $$PWD/res.qrc 

HeadPath = $$absolute_path($$PWD\\..\\$$TARGET\\iDatabaseTableQueryPluginservice.h) 
