...
CONFIG += c++14 
TARGET = SecondMotionControlPlugin 
...
HEADERS += \
    SecondMotionControlDialog.h \
    isecondmotioncontrolpluginservice.h  \ 
    secondmotioncontrolpluginservice.h  \ 
    secondmotioncontrolpluginactivator.h 

SOURCES += \
    SecondMotionControlDialog.cpp \
    secondmotioncontrolpluginservice.cpp \ 
    secondmotioncontrolpluginactivator.cpp 

RESOURCES += \
    $$PWD/res.qrc 

HeadPath = $$absolute_path($$PWD\\..\\$$TARGET\\iSecondMotionControlPluginservice.h) 
