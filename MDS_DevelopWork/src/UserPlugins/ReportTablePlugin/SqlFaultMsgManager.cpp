...
SqlFaultMsgManager::SqlFaultMsgManager(QObject* parent)
    : QObject(parent)
    ...
    , hasQueryFinished(true)
{
    ...
    else
    {
        ...
        {
            QString creatTableStr = "CREATE TABLE IF NOT EXISTS faultMsg("
                                    "taskNum VARCHAR(100) , "
...
bool SqlFaultMsgManager::queryFinished() { return hasQueryFinished; }

void SqlFaultMsgManager::insert(const QList<FaultMsgData>& imager)
{
...
void SqlFaultMsgManager::searchLog(const QStringList& devices, const QStringList& units, const QStringList& sids, const QStringList& aa,
...
void SqlFaultMsgManager::totalCount(const QStringList& devices, const QStringList&, const QStringList&, const QStringList&,
