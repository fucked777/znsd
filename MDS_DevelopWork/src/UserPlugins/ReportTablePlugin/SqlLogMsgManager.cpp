...
SqlLogMsgManager::SqlLogMsgManager(QObject* parent)
    : QObject(parent)
...
bool SqlLogMsgManager::queryFinished() { return hasQueryFinished; }

void SqlLogMsgManager::insert(const QList<LogMsgData>& imager)
{
...
void SqlLogMsgManager::searchLog(const QStringList& devices, const QStringList& units, const QStringList& sids, const QStringList& aa,
...
void SqlLogMsgManager::totalCount(const QStringList& devices, const QStringList&, const QStringList&, const QStringList&, const QDateTime& start_time,
